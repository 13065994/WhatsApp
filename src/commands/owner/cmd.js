...
module.exports = {
  ...
  usage: [
    '!cmd install <filename.js> <code or link>',
  ...
  async execute(sock, message, args, user) {
    ...
    switch (action) {
      ...
      case 'loadall':
        const up = '|____________________|Loading|____________________|\n';
        try {
          const loaded = [];
          const errors = [];
          let loadMessage = '';
          ...
          loadMessage += '|____________________|×ღ×|____________________|\n';
      ...
      switch (action) {
        case 'install':
          ...
          if (url.match(/(https?:\/\/(?:www\.|(?!www)))/)) {
            console.log(`Installed command from URL: ${url}`);
            ...
            if (domain == "pastebin.com") {
              ...
              return await sock.sendMessage(chatId, {
                text: 'Please provide a raw Pastebin link.',
              }, { quoted: message });
            }
